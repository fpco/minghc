...
source _ Alex ver = "https://s3.amazonaws.com/download.fpcomplete.com/minghc/alex-" ++ ver ++ ".exe"
-- Version compiled by Michael Snoyman using GHC 7.8.3
source _ Happy ver = "https://s3.amazonaws.com/download.fpcomplete.com/minghc/happy-" ++ ver ++ ".exe"
