...
* [**Download installer with GHC 7.8.4 (32-bit)**](https://s3.amazonaws.com/download.fpcomplete.com/minghc/minghc-7.8.4-i386.exe)
...
* Run `cabal install`.
* Run `minghc-generate`. That will generate a file `.build/minghc-7.10.1.exe`.
